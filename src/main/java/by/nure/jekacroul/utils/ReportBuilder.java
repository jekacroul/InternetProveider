package by.nure.jekacroul.utils;
...
public class ReportBuilder {
    public static void contractPDF(HttpServletResponse response, User user) {
        ...
        try {
            ...
            Paragraph title1 = new Paragraph("Договор на оказание услуг между компанией ООО «ШпаркиСнеговик» и физическим лицом", new Font(arial, 10));
            ...
            Paragraph footer = new Paragraph("© 2002-2023 ООО «ШпаркиСнеговик»", new Font(arial, 10));
            section1.add(footer);
